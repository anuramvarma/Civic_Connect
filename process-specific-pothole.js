// Process Specific Pothole Complaint with SIH YOLO Model
...
async function processSpecificPotholeComplaint() {
  try {
    console.log('🔌 Connecting to MongoDB...');
    await mongoose.connect(MONGODB_URI);
    console.log('✅ Connected to MongoDB');

    console.log('\n🚧 Processing Specific Pothole Complaint...\n');

    // The specific complaint ID from your database
    const complaintId = '68cd2008ef99b2f8ced0510d';
    ...
    console.log('\n🎉 Pothole Complaint Processing Complete!');
...
// Run the processing
processSpecificPotholeComplaint();
